...
import { faCheckCircle, faExclamationCircle, faPaperPlane, faArrowLeft } from '@fortawesome/free-solid-svg-icons';
import subscribeImage from '../../assets/images/subscribe-bg.avif';
    ...
    useEffect(() => {
        const ctx = gsap.context(() => {
            ...
            tl.to('.image-anim', { autoAlpha: 1, scale: 1, duration: 1.2, ease: 'power3.out' })
                .to('.form-anim', { y: 0, autoAlpha: 1, stagger: 0.15, duration: 1, ease: 'power3.out' }, "-=0.8");
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 w-full">
                ...
                <div className="flex flex-col justify-center items-center p-8 sm:p-12 lg:p-16 order-2 lg:order-1">
                    <div className="w-full max-w-md">
                                ...
                                <div className="form-anim">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full px-4 py-3 text-lg bg-white border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-accent focus:border-accent transition"
                                        />
                                        <button
                                            type="submit"
                                            disabled={status === 'loading'}
                                            className="absolute inset-y-0 right-0 flex items-center justify-center px-5 text-accent hover:text-opacity-80 disabled:text-gray-400 transition"
                        ...
                        <p className="form-anim text-xs text-gray-400 mt-4 text-center">We respect your privacy. Unsubscribe at any time.</p>

                    </div>
                </div>

                {/* --- Right Panel: Image --- */}
                {/* This panel is hidden on mobile and appears on large screens */}
                <div className="hidden lg:block order-1 lg:order-2 relative">
                    <div className="absolute inset-0 w-full h-full overflow-hidden">
                        <img
                            src={subscribeImage}
                            alt="Artisanal bread being sliced"
